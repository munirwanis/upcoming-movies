...
extension TableViewReusable where Self : UITableView {
    ...
    func register<T: UITableViewCell>(cellNib: T.Type) {
    ...
    func register<T: UITableViewHeaderFooterView>(viewClass: T.Type) {
    ...
    func register<T: UITableViewHeaderFooterView>(viewNib: T.Type) {
